...
use device_envoy_esp::{
    ...
    button::PressedTo,
    button_watch,
    cyd::{CydEspOneSpi, CydStaticEsp, DEFAULT_FONT, NoDisplayReset, Orientation},
...
async fn inner_main(spawner: Spawner) -> Result<Infallible, Error> {
    ...
    info!("Starting CYD armatron loop (one-SPI) on ESP32 / generic");
