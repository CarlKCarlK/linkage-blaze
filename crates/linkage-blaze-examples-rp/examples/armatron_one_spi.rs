...
use device_envoy_rp::{
    ...
    cyd::{CydRpOneSpi, CydRpOneSpiStatic, DEFAULT_FONT, Error as CydError, Orientation},
...
async fn reboot_with_message(cyd: &mut CydRpOneSpi<SPI0>, message: &str) -> Result<(), Error> {
