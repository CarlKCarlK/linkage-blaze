...
#[test]
fn scene_with_arm_fixed_and_buf_are_equivalent() -> Result<(), linkage_blaze::Error> {
...
#[test]
fn named_program_buf_matches_fixed() -> Result<(), linkage_blaze::Error> {
...
#[cfg(feature = "alloc")]
#[test]
fn clock_from_file_both_storage_types() -> Result<(), linkage_blaze::Error> {
    let buf = clock_hands::buf();
    let params = [0.25, 0.5];
...
#[test]
fn clock_hands_fixed_and_buf_equivalent() -> Result<(), linkage_blaze::Error> {
...
#[test]
fn armatron_component_linkages_fixed_and_buf_equivalent() -> Result<(), linkage_blaze::Error> {
...
#[test]
fn armatron_grid_fixed_and_buf_equivalent() -> Result<(), linkage_blaze::Error> {
...
#[test]
fn armatron_combined_linkages_fixed_and_buf_equivalent() -> Result<(), linkage_blaze::Error> {
...
#[test]
fn armatron_full_scene_linkage_built_with_buf() -> Result<(), linkage_blaze::Error> {
    let armatron1 = armatron1::buf();
    let camera_control = camera_control::buf();
    let grid9x9 = grid9x9::buf();
...
#[cfg(feature = "alloc")]
#[test]
fn conversion_linkage_fixed_to_buf() -> Result<(), linkage_blaze::Error> {
...
#[cfg(feature = "alloc")]
#[test]
fn linkage_buf_combine_combines_params_and_steps() -> Result<(), linkage_blaze::Error> {
...
#[cfg(feature = "alloc")]
#[test]
fn linkage_buf_combine_combines_from_view() -> Result<(), linkage_blaze::Error> {
...
#[cfg(feature = "alloc")]
#[test]
fn armatron_buf_combine_combines_limbs() -> Result<(), linkage_blaze::Error> {
